...
export function buildContractScreen(input: ScreenInput): ContractScreen {
  ...
  return {
    ...
    caveats: [
      ...
      "asymmetry_ratio and iv_rv_ratio are UNVALIDATED. Neither has a forward record and neither contributes to the ordering. The IV/RV screen is under a pre-declared kill line and cannot speak until its gate is met.",
