...
export const EXCHANGES: ExchangeMeta[] = [
  ...
  },
  {
    ...
    assets: ["BTC", "ETH", "SOL"],
    // No confirmed public REST endpoint for Perps market stats, so Jupiter
    // arrives via DefiLlama/CoinGecko unless JUPITER_PERPS_URL is set.
    providerOnly: true,
  },
  {
    id: "drift",
  ...
  { id: "deribit", name: "Deribit", type: "CEX", status: "live", color: "#00A7E1",
    docsUrl: "https://docs.deribit.com/", assets: ALL_ASSETS, providerOnly: true },
  { id: "mexc", name: "MEXC", type: "CEX", status: "live", color: "#00CFAE",
    docsUrl: "https://mexcdevelop.github.io/apidocs/contract_v1_en/", assets: ALL_ASSETS, providerOnly: true },
  { id: "htx", name: "HTX", type: "CEX", status: "live", color: "#2CA6E0",
    docsUrl: "https://huobiapi.github.io/docs/dm/v1/en/", assets: ALL_ASSETS, providerOnly: true },
  ...
  { id: "coinbase-intl", name: "Coinbase Intl.", type: "CEX", status: "live", color: "#1652F0",
    docsUrl: "https://docs.cdp.coinbase.com/intx/docs/welcome", assets: ALL_ASSETS, providerOnly: true },
  ...
  { id: "aevo", name: "Aevo", type: "DEX", status: "live", color: "#FF3B69",
    docsUrl: "https://docs.aevo.xyz/", assets: ALL_ASSETS, providerOnly: true },
  ...
  { id: "paradex", name: "Paradex", type: "DEX", status: "live", color: "#B026FF",
    docsUrl: "https://docs.paradex.trade/", assets: ALL_ASSETS, providerOnly: true },
  ...
  { id: "aster", name: "Aster", type: "DEX", status: "live", color: "#F59E0B",
    docsUrl: "https://docs.asterdex.com/", assets: ALL_ASSETS, providerOnly: true },
];
